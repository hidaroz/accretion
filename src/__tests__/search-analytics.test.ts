...
describe("SearchAnalytics", () => {
  it("appends a hybrid_search entry with the rich telemetry fields", async () => {
    ...
    const entry: SearchLogEntry = {
      ...
      tool: "hybrid_search",
      query: "what is the Observability migration roadmap",
      vault: "work",
      resultCount: 5,
      topPaths: ["10-Roadmap/Observability Migration Roadmap.md"],
      limit: 8,
      semanticAvailable: true,
      route: { method: "direct_map", path: "04-Operations/brief-observability.md", score: 9.1 },
      pinApplied: true,
